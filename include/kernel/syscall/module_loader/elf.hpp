...
private:
    ...
    struct [[gnu::packed]] ProgramHeaderTable {
        Elf64_Word p_type;
        Elf64_Word p_flags;
    ...
    struct [[gnu::packed]] Relocation {
        Elf64_Address r_offset;
        Elf64_Xword r_info;
        Elf64_Sxword r_addend;
    };

    struct [[gnu::packed]] SectionHeaderEntries {
        Elf64_Word sh_name;
        Elf64_Word sh_type;
    ...
    struct [[gnu::packed]] DynamicTable {
        Elf64_Xword d_tag;
        union {
            Elf64_Xword d_val;
            Elf64_Address d_ptr;
    ...
    struct [[gnu::packed]] SymbolTableInformation {
        SectionHeaderEntries *shdr;
        std::size_t shdr_count;
        SymbolTable *sym_entries;
        std::size_t sym_count;
        char *sym_str_table;
        std::size_t sym_str_table_size;
        char *sect_str_table;
        std::size_t sect_str_table_size;
    };
