...
class ApicPerformanceCounterEntry : public InterruptEntry {
public:
    explicit ApicPerformanceCounterEntry( void ) noexcept = default;
    virtual ~ApicPerformanceCounterEntry( void ) noexcept = default;
