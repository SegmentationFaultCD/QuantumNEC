...
namespace Driver {
struct XSDT : Table::ACPISDTHeader {
    ...
    template < typename TableType >
        requires std::invocable< typename TableType::get_signature >
    auto find_table( uint32_t signature = TableType::get_signature( ) ) -> TableType::table_type * {
