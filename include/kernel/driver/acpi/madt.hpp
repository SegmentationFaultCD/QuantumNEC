...
PUBLIC namespace QuantumNEC::Kernel::x86_64 {
    ...
    private:
        ...
        struct IOApicInterruptSourceOverride : MadtICS
        {
        ...
        struct IOAPICNonMaskableInterruptSource : MadtICS
        {
        ...
        struct LocalAPICNonMaskableInterrupts : MadtICS
        {
        ...
        struct LocalAPICAddressOverride : MadtICS
        {
        ...
        struct ProcessorLocalx2APIC : MadtICS
        {
    ...
    public:
        struct MADT : Xsdt::ACPISDTHeader
        {
        ...
        struct HPET : Xsdt::ACPISDTHeader
        {
