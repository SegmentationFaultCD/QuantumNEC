 ...
 */
auto mov16( OUT uint8_t *dst, IN const uint8_t *src ) -> void {
#if defined( __x86_64__ )
    ASM( "movdqu (%[src]), %%xmm0\n\t"
         "movdqu %%xmm0, (%[dst])\n\r" : : [src] "r"( src ),
         [dst] "r"( dst ) : "xmm0", "memory" );
#elif defined( __aarch64__ ) || defined( __riscv )
#elif defined( __loongarch64 )
#endif
}
 ...
 *   Pointer to the source data.
 */
auto mov32( OUT uint8_t *dst, IN const uint8_t *src ) -> void {
#if defined( __x86_64__ )
    ASM( "movdqu (%[src]), %%xmm0\n\t"
         "movdqu 16(%[src]), %%xmm1\n\t"
         "movdqu %%xmm0, (%[dst])\n\t"
         "movdqu %%xmm1, 16(%[dst])\n\r" : : [src] "r"( src ),
         [dst] "r"( dst ) : "xmm0", "xmm1", "memory" );
#elif defined( __aarch64__ ) || defined( __riscv )
#elif defined( __loongarch64 )
#endif
}
 ...
 *   Pointer to the source data.
 */
auto mov48( OUT uint8_t *dst, IN const uint8_t *src ) -> void {
#if defined( __x86_64__ )
    ASM( "movdqu (%[src]), %%xmm0\n\t"
         "movdqu 16(%[src]), %%xmm1\n\t"
         "movdqu 32(%[src]), %%xmm2\n\t"
 ...
 *   Pointer to the source data.
 */
auto mov64( OUT uint8_t *dst, IN const uint8_t *src ) -> void {
#if defined( __x86_64__ )
    ASM( "movdqu (%[src]), %%xmm0\n\t"
         "movdqu 16(%[src]), %%xmm1\n\t"
         "movdqu 32(%[src]), %%xmm2\n\t"
         ...
         "movdqu %%xmm2, 32(%[dst])\n\t"
         "movdqu %%xmm3, 48(%[dst])\n\r" : : [src] "r"( src ),
         [dst] "r"( dst ) : "xmm0", "xmm1", "xmm2", "xmm3", "memory" );
#elif defined( __aarch64__ ) || defined( __riscv )
#elif defined( __loongarch64 )
#endif
}
 ...
 *   Pointer to the source data.
 */
auto mov128( OUT uint8_t *dst, IN const uint8_t *src ) -> void {
#if defined( __x86_64__ )
    ASM( "movdqu (%[src]), %%xmm0\n\t"
         "movdqu 16(%[src]), %%xmm1\n\t"
         "movdqu 32(%[src]), %%xmm2\n\t"
         ...
         "movdqu %%xmm6, 96(%[dst])\n\t"
         "movdqu %%xmm7, 112(%[dst])\n\r" : : [src] "r"( src ),
         [dst] "r"( dst ) : "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5", "xmm6", "xmm7",
         "memory" );
#elif defined( __aarch64__ ) || defined( __riscv )
#elif defined( __loongarch64 )
#endif
 ...
 *   Pointer to the source data.
 */
auto mov256( OUT uint8_t *dst, IN const uint8_t *src ) -> void {
#if defined( __x86_64__ )
    /*
