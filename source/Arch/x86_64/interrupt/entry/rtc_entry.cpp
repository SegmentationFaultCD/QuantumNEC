...
PUBLIC namespace QuantumNEC::Architecture {
    PRIVATE auto ASMCALL rtc_handler( IN CONST InterruptDescriptorTable::InterruptFrame * frame, IN uint64_t )->CONST InterruptDescriptorTable::InterruptFrame * {
        return frame;
    }
    ...
    RTCEntry::RTCEntry( VOID ) noexcept {
        ...
        Architecture::InterruptDescriptorTable::register_irq( IRQ_CMOS_RTC, &entry, rtc_handler, 0, "CMOS RTC", &controller );
    }
}