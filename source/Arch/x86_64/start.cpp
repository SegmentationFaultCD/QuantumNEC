...
_C_LINK auto micro_kernel_entry( VOID ) -> VOID {
    Architecture::__config.graphics_data = *framebuffer_request.response->framebuffers[ 0 ];
    Architecture::__config.memory_map = *memmap_request.response;
    Architecture::__config.acpi_table = *acpi_request.response;
    Architecture::__config.hhdm = *hhdm_request.response;
    Architecture::__config.smp = *smp_request.response;
    ...
    s = allocater.__allocate< MemoryPageType::PAGE_2M >( 1028 );
    println< ostream::HeadLevel::DEBUG >( "{}", s );
    collector.__free< MemoryPageType::PAGE_2M >( s, 1028 );
