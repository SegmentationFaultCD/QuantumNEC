    ...
    Madt::Madt( IN Xsdt & xsdt ) noexcept {
        ...
        while ( length > 0 ) {
            ...
            case ICSAttribute::PROCESSOR_LOCAL_APIC: {
                ...
                Architecture::Apic::apic_map.local_apic_ID[ Architecture::Apic::apic_map.core_count++ ] = entry->APIC_ID;
            } break;
        ...
        Architecture::Apic::apic_map.local_apic_address = reinterpret_cast< uint64_t >( ( Kernel::physical_to_virtual( this->madt->local_apic_address ) ) );
