...
PUBLIC namespace QuantumNEC::Architecture {
    ...
    CMOS::CMOS( VOID ) noexcept {
        ...
        // 设置CMOS中断频率
        Architecture::CPUs::io_out8( static_cast< uint8_t >( CMOSType::CMOS_A ), ( CPUs::io_in8( static_cast< uint8_t >( CMOSType::CMOS_A ) ) & 0xf ) | 14 );
    }
    CMOS::~CMOS( VOID ) noexcept {
    }
    ...
    auto CMOS::read_cmos( IN uint8_t address ) -> uint8_t {
        CPUs::io_out8( CMOS_ADDRESS, static_cast< uint8_t >( TimeType::NMI ) | static_cast< uint8_t >( address ) );
        auto value = CPUs::io_in8( CMOS_DATA );
