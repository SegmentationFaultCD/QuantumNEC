...
PUBLIC namespace QuantumNEC::Architecture {
    ...
    PUBLIC auto syscall_send_receive( IN InterruptDescriptorTable::InterruptFrame * frame ) -> InterruptDescriptorTable::InterruptFrame * {
        auto status { SyscallStatus::ERROR };
        auto function { static_cast< SyscallFunction >( frame->regs.rax ) };
    ...
    auto Message::send( IN uint64_t destination ) -> SyscallStatus {
    ...
    auto Message::receive( IN uint64_t source ) -> SyscallStatus {
