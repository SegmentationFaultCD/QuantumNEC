...
#include <Arch/x86_64/cpu/descriptor.hpp>
...
PUBLIC namespace QuantumNEC::Architecture {
    ...
    public:
         ...
         * @brief 中断入口函数表
         */
        inline STATIC Architecture::InterruptDescriptorTable::InterruptEntry interrupt_entry_table[ INTERRUPT_DESCRIPTOR_COUNT ] { };
