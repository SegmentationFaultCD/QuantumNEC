...
PUBLIC namespace QuantumNEC::Kernel {
    ...
    public:
        ...
        constexpr static auto page_header_count { __page_allocater::__page_size< _prev_info_block_allocater > / ( page_information_block_size + page_bitmap_size ) };
