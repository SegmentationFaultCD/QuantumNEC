...
PUBLIC namespace QuantumNEC::Kernel {
    ...
    public:
        ...
        auto check_page_size( IN MemoryPageType mode ) {
            ...
            switch ( mode ) {
            case PAGE_2M:
                return __page_allocater::__page_size< PAGE_2M >;
            case PAGE_4K:
                return __page_allocater::__page_size< PAGE_4K >;
            case PAGE_1G:
                return __page_allocater::__page_size< PAGE_1G >;
            default:
                return 0ul;
            }
        }
    ...
    public:
        explicit __paging( VOID ) noexcept;
    };
}